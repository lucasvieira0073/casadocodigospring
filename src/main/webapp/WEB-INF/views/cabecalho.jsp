...
<%@ taglib uri="http://www.springframework.org/security/tags" prefix="security"%>
  ...
  <header id="layout-header">
		<div class="clearfix container">
			<a href="${s:mvcUrl('HC#index').build()}" id="logo"><img src="${imgPath}cdc-logo.svg" />
			</a>
				...
				<nav id="main-nav">
					...
					<ul class="clearfix">
						<li>
							...
							<!-- com jstl -->
								<!--fmt:message key="menu.carrinho"  EL ({carrinhoCompras.quantidade}) 
									
									fmt:param value="{carrinhoCompras.quantidade}"
								fmt:message-->
								
								<!-- com spring -->
								<s:message code="menu.carrinho" arguments="${carrinhoCompras.quantidade}"/><!-- pode por virgula e passar mais parametros -->
							</a>
						</li>
							<!-- tambem pode usar  access="isAuthenticated()  -->
