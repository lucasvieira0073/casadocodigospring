...
<!-- aqui podera colocar os scripts e imports , lembrando que sempre que utilizar o attribute deverá utilizar a tag body, e o attribute sempre vem antes de tudo -->
...
<jsp:body>
	<section class="container middle">
		  <h2 id="cart-title"><a href="${s:mvcUrl('CCC#itens').build() }">Seu carrinho de compras (${carrinhoCompras.quantidade})</a></h2>
			      ...
			      <tr>
			          ...
			          <c:url value="/resources/img/" var="imgPath"/>
			          	<form:form action="${s:mvcUrl('CCC#remover').arg(0, item.produto.id).arg(1, item.tipoPreco).build()}" method="post">
			          		<input type="image" src="${imgPath}excluir.png" alt="Excluir" title="Excluir" />
			          	</form:form>
			          </td>
			      </tr>
			      </c:forEach>
